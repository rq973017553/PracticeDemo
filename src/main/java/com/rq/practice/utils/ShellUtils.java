...
public class ShellUtils {
	...
	public static CommandResult execCommand(String command, boolean isRoot,
			boolean exit) {
		return execCommand(new String[] { command }, isRoot, true, exit);
	}
	...
	public static CommandResult execCommand(String[] commands, boolean isRoot,
			boolean exit) {
		return execCommand(commands, isRoot, true, exit);
	}
	 ...
	 */
	public static CommandResult execCommand(List<String> commands,
			boolean isRoot, boolean isNeedResultMsg, boolean exit) {
		return execCommand(
				commands == null ? null : commands.toArray(new String[] {}),
				isRoot, isNeedResultMsg, exit);
	}
